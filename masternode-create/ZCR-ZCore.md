# Tutorial de criação de masternode ZCore hospedado pela True Nodes
...
* 5000 ZCR para cada masternode que for criar (compre uma fração a mais, pois você pode ter que pagar taxas de transação)
...
11. Será aberto um arquivo onde fica uma lista contendo os masternodes. No final do arquivo adicione a(s) linha(s) que eu lhe enviei sendo que cada linha corresponde a um masternode. Salve o arquivo e feche. Feche também a carteira ZCore e abra ela novamente para que a configuração seja aplicada e apareça em sua tela.
